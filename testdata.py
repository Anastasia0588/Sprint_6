...
class OrderData:
    ...
    user = [['Люк', 'Скайуокер', 'Татуин', random.choice(metro),'grey', f'+7{randint(0000000000, 9999999999)}'],
            ['Джон', 'Сноу', 'Винтерфелл', random.choice(metro), 'black', f'+7{randint(0000000000, 9999999999)}']]
